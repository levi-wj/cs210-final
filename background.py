...
Reasoning:
    This file uses inheritance because the bglayer inherits from the pygame sprite class
    and the class abstracts the movement of the images from the main class
'''
